# Anti-Vibe-Coded Design Guidelines

This document outlines the core principles and red flags to avoid creating "vibe coded" (rushed, inconsistent, template-heavy) designs. It serves as both a manual for human developers and a strict system prompt for AI assistants working on this project.
...
Huge 48px icon. Text so small it feels like an afterthought.
...
### 1. No Loading States
A big one. When you click something and nothing happens for seconds, the whole experience feels amateur.
...
*Not a visual issue, but users feel it. And when users feel it, the entire site gets labeled vibe coded.*
